...
public class GuiAdvancedCompressor extends GuiAdvancedBase {
    ...
    protected void drawGuiContainerForegroundLayer() {
        ...
        drawStringCenteredNoShadow(fontRenderer, i18n.translateKey("gui.industry.t2.compressor"), scrnX, 6, 4210752);
    ...
    // This is copied from "BTBTA", so shout out to them for figuring this out.  | You're welcome -Useless
    @Override
