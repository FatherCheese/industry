...
import cookie.industry.recipe.RecipesExtractor;
...
public class GuiAdvancedExtractor extends GuiAdvancedBase {
    ...
    protected void drawGuiContainerForegroundLayer() {
        ...
        drawStringCenteredNoShadow(fontRenderer, i18n.translateKey("gui.industry.t2.extractor"), scrnX, 6, 4210752);
    ...
    public void clickInventory(int x, int y, int mouseButton) {
        ...
        if (this.inventorySlots instanceof ContainerAdvancedBase) { // This is the only section that actually really matters
            boolean recipes = new RecipesExtractor().getRecipeList().containsKey(clickedItemId);
