...
public class GuiMachineFurnace extends GuiMachineBase {
    ...
    public GuiMachineFurnace(InventoryPlayer inventory, TileEntityMachineBase tileEntity) {
    ...
    protected void drawGuiContainerForegroundLayer() {
        ...
        drawStringCenteredNoShadow(fontRenderer, i18n.translateKey("gui.industry.t1.furnace"), scrnX, 6, 4210752);
