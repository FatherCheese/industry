...
public class GuiMachineMacerator extends GuiMachineBase {
    ...
    protected void drawGuiContainerForegroundLayer() {
        ...
        drawStringCenteredNoShadow(fontRenderer, i18n.translateKey("gui.industry.t1.macerator"), scrnX, 6, 4210752);
    ...
    public void clickInventory(int x, int y, int mouseButton) {
        ...
        if (this.inventorySlots instanceof ContainerMachineBase) { // This is the only section that actually really matters
            boolean recipes = new RecipesMacerator().getRecipeList().containsKey(clickedItemId);
