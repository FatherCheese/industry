...
public class GuiArrayMV extends GuiSolarBase {

    public GuiArrayMV(InventoryPlayer inventory, TileEntitySolarBase tileEntity) {
    ...
    protected void drawGuiContainerForegroundLayer() {
        ...
        drawStringCenteredNoShadow(fontRenderer, i18n.translateKey("gui.industry.array.mv"), scrnX, 6, 4210752);
