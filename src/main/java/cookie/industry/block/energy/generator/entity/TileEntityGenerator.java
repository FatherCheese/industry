...
import cookie.industry.block.energy.generator.BlockGenerator;
import cookie.industry.recipe.fuel.GeneratorFuel;
...
public class TileEntityGenerator extends TileEntityEnergyConductor implements IInventory {
    ...
    public TileEntityGenerator() {
        ...
        setCapacity(I2Config.cfg.getInt("Energy Values.lvMachineStorage") * 4);
