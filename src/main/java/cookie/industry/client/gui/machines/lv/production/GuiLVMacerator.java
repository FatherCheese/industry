...
public class GuiLVMacerator extends GuiLVMachineBase {

    public GuiLVMacerator(InventoryPlayer inventory, TileEntityLVMacerator tileEntity) {
    ...
    protected void drawGuiContainerForegroundLayer() {
        ...
        drawStringCenteredNoShadow(fontRenderer, i18n.translateKey("gui.industry.lv_macerator"), scrnX, 6, 4210752);
