...
public class ContainerLVCanningMachine extends ContainerEnergy {
    private final TileEntityLVMachineBase tileEntity;
    private final int energy = 0;
    private final int machineTick = 0;
    public ContainerLVCanningMachine(InventoryPlayer inventory, TileEntityLVMachineBase tileEntity) {
