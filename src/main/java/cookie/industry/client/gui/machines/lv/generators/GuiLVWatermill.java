...
public class GuiLVWatermill extends GuiContainer {
    private final TileEntityLVWatermill tileEntity;
    private final I18n i18n = I18n.getInstance();
    public GuiLVWatermill(InventoryPlayer inventory, TileEntityLVWatermill tileEntity) {
        super(new ContainerLVWatermill(inventory, tileEntity));
    ...
    protected void drawGuiContainerForegroundLayer() {
        ...
        drawStringCenteredNoShadow(fontRenderer, i18n.translateKey("gui.industry.lv_watermill"), scrnX, 6, 4210752);
