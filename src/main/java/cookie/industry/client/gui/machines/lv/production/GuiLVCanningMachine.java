...
public class GuiLVCanningMachine extends GuiContainer {
    private final TileEntityLVMachineBase tileEntity;
    protected final I18n i18n = I18n.getInstance();

    public GuiLVCanningMachine(InventoryPlayer inventory, TileEntityLVCanningMachine tileEntity) {
        super(new ContainerLVCanningMachine(inventory, tileEntity));
        this.tileEntity = tileEntity;
    }

    @Override
    protected void drawGuiContainerBackgroundLayer(float f) {
        int texture = mc.renderEngine.getTexture("/assets/industry/textures/gui/machine_double.png");
    ...
    protected void drawGuiContainerForegroundLayer() {
        ...
        drawStringCenteredNoShadow(fontRenderer, i18n.translateKey("gui.industry.lv_canning_machine"), scrnX, 6, 4210752);
