...
import cookie.industry.core.block.energy.charger.entity.TileEntityChargerHV;
...
public class BlockChargerHV extends BlockTileEntity {
    ...
    public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int x, int y, int z, int meta, TileEntity tileEntity) {
        return dropCause != EnumDropCause.IMPROPER_TOOL ? new ItemStack[]{new ItemStack(I2ItemsNew.HV_CHARGING_PAD)} : null;
    }
}
