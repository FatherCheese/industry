...
public class BlockInsulatedCableSteel extends BlockCable {
    public BlockInsulatedCableSteel(String key, int id) {
        super(key,
                id,
                Material.cloth,
    ...
    public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int x, int y, int z, int meta, TileEntity tileEntity) {
        switch (dropCause) {
            ...
            case PROPER_TOOL:
            case WORLD:
                return new ItemStack[]{I2ItemsNew.INSULATED_STEEL_CABLE.getDefaultStack()};
            case IMPROPER_TOOL:
            default:
                return new ItemStack[]{I2ItemsNew.STEEL_CABLE.getDefaultStack()};
            case EXPLOSION:
