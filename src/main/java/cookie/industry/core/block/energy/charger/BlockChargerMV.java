...
import cookie.industry.core.block.energy.charger.entity.TileEntityChargerMV;
...
public class BlockChargerMV extends BlockTileEntity {
    ...
    public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int x, int y, int z, int meta, TileEntity tileEntity) {
        return dropCause != EnumDropCause.IMPROPER_TOOL ? new ItemStack[]{new ItemStack(I2ItemsNew.MV_CHARGING_PAD)} : null;
    }
}
