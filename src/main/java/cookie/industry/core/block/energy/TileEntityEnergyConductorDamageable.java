package cookie.industry.core.block.energy;
    ...
    public void tick() {
        ...
        if (!worldObj.isClientSide) {
            ...
            if (machineHealth < maxMachineHealth) {
                ...
                worldObj.spawnParticle("smoke", randX, randY + 0.22, randZ, 0.0, 0.0, 0.0, 0);
                worldObj.spawnParticle("flame", randX, randY + 0.22, randZ, 0.0, 0.0, 0.0, 0);
            }
