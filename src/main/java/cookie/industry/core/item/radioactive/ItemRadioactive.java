package cookie.industry.core.item.radioactive;
...
public class ItemRadioactive extends Item {
    ...
    private boolean isArmoured(Entity entity) {
        ...
        return ((EntityPlayer) entity).inventory.armorInventory[3].itemID == I2ItemsNew.HAZMAT_HELMET.id      &&
                ((EntityPlayer) entity).inventory.armorInventory[2].itemID == I2ItemsNew.HAZMAT_CHESTPLATE.id &&
                ((EntityPlayer) entity).inventory.armorInventory[1].itemID == I2ItemsNew.HAZMAT_LEGGINGS.id   &&
                ((EntityPlayer) entity).inventory.armorInventory[0].itemID == I2ItemsNew.HAZMAT_BOOTS.id;
    }
