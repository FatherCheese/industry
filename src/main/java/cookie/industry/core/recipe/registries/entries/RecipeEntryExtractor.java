...
public class RecipeEntryExtractor extends RecipeEntryBase<RecipeSymbol, ItemStack, Void> {
    public RecipeEntryExtractor(RecipeSymbol input, ItemStack output) {
    ...
    private boolean matchesScope(SearchQuery query) {
        if (query.scope.getLeft() == SearchQuery.SearchScope.NONE) return true;
            ...
            if (query.scope.getLeft() == SearchQuery.SearchScope.NAMESPACE) {
                ...
                RecipeGroup<RecipeEntryExtractor> group;
                try {
