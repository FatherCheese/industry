...
//        addFuel(I2BlocksNew.RUBBERWOOD_SAPLING.id, 25);
...
//        addFuel(I2BlocksNew.RUBBERWOOD_LOG.id, 75);
//        addFuel(I2BlocksNew.RUBBERWOOD_RESIN_LOG.id, 75);
//        addFuel(I2BlocksNew.EMPTY_RUBBERWOOD_RESIN_LOG.id, 75);
        ...
        addFuel(I2ItemsNew.SCRAP.id, 87);
